...
/**
 * author : abel.tang
 * Date: 2019-09-03  9:46
 */

namespace wxwork\api;


use think\Container;
use wxwork\api\src\Department;
use wxwork\api\src\tag\Tag;
use wxwork\api\src\user\User;
use wxwork\api\src\UserDetailByUserTicket;
use wxwork\api\src\UserInfoByCode;
use wxwork\exception\ParameterError;
use wxwork\exception\QyApiError;
use wxwork\utils\Utils;
use wxwork\utils\HttpUtils;
...
class CorpAPI extends API
{
    ...
    public function UploadImage($filePath, $md5 = null)
    {
        ...
        $this->_HttpPostParseToJson($url, $args, true, true);
        $this->_CheckErrCode();
    ...
    public function GetUserDetailByUserTicket($ticket)
    {
        ...
        Container::get('app')->log($this->rspJson, 'debug');
